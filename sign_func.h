...
public:
	...
	bool GetAttachment( CBaseEntity* pEnt, const char *szName, const Vector* absOrigin, const Vector *forward = NULL, const Vector *right = NULL, const Vector *up = NULL );
	bool GetAttachment( CBaseEntity* pEnt, const char* szName, const Vector* absOrigin, const QAngle* absAngle);
